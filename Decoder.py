...
from SM import SM
# from Visual_Enhancement import Visual_Enhance
from Visual_Enhancement import Visual_Enhance
...
class Decoder(nn.Module):
    def __init__(self, input_channel, input_size):
        ...
        self._up_layer_1 = nn.Sequential(
            ...
            # Visual_Enhance(input_channel // 2),
            # SM(in_channels=input_channel // 2),
        ...
        self._up_layer_2 = nn.Sequential(
            ...
            #Visual_Enhance(input_channel // 4),
            # SM(in_channels=input_channel // 4),
        ...
        self._up_layer_3 = nn.Sequential(
            ...
            # Visual_Enhance(input_channel // 8),
            # SM(in_channels=input_channel // 8),
        ...
        self._up_layer_4 = nn.Sequential(
            ...
            # Visual_Enhance(input_channel // 16),
            # SM(in_channels=input_channel // 16),
